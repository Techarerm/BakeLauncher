...
import psutil
import json
from LauncherBase import print_custom as print, timer
        ...
        for i in range(len(lines)):
            if "Add>" in data:
                ...
                if add_item.lower() in lines[i].lower().strip():
                    ...
                    print("Failed to append new args to config file! Cause by args already exist in the config.",
                          color='red')
                    time.sleep(2)
                else:
...
def custom_jvm_args(path, mode):
    ...
    if mode == "EditRAMSize":
        ...
        print(
            "IMPORTANT: Backup your old JVM Args(without memory args)! Is really important if you want to restore your old args.\n"
            "If you enter exceeds the size of your computer's memory, you may get crash when you launch Minecraft!",
            color='red')
        print(
            "This function is mainly for advanced users. If you are not, please use Generate Args adapted to your computer!",
            color='yellow')
        print(
            "Also use this method will overwrite your old config. After doing this, you may need to go CustomEdit to paste your old args and restore.",
            color='yellow')
        while True:
            try:
