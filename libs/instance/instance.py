...
class class_instance:
    ...
    def create_instance_info(self, instance_name, client_version, version_type, is_vanilla, modify_status,
        ...
        instance_info = textwrap.dedent(f"""\
            ...
            # This configuration stores instance data for the launcher (Example: instance_name, client_version).
            ...
            # Instance Structure
            game_folder = "{self.game_folder}"  # Path to the main game folder
