...
def login():
    ...
    print("AuthTool: You must manually use a web browser to login your account!!!", color='red')
    print("AuthTool: Rememver to paste url after you login :)", color='green')
